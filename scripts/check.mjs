...
for(const asset of ['assets/title.png','assets/sprites.png','game/app.js','game/engine.js','game/catalog.js','game/renderer.js','game/audio.js'])await access(join(root,asset));
